...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            mediapipe_draw.draw_landmarks(img, hand_landmark,
            mediapipe_hands.HAND_CONNECTIONS, mediapipe_draw.DrawingSpec((0,0,255),2,2),
            mediapipe_draw.DrawingSpec((0,255,0),4,2))
